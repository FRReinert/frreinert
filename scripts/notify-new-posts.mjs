 ...
 *
 * Local (dry-run):
 *   node scripts/notify-new-posts.mjs --dry-run src/content/publicacoes/foo.md
 */
...
/** Produção — mesmo valor de src/lib/push.ts (App ID é público). */
...
for (const file of files) {
  ...
  const slug = data.path_slug || slugFromPath(file);
